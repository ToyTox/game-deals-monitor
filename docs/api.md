...
Веб-интерфейс (`public/index.html`): статистика, панель ручек для всех методов API и карточки игр. В разделах «Бесплатные игры» и «Скидки» есть фильтр по платформам (можно выбрать несколько) и сортировка; выбор хранится в `localStorage` отдельно для каждого раздела.
