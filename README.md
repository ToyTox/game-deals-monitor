...
Отдельно есть персональный срез: по SteamID (или ссылке на профиль, или нику) сервис читает **список желаемого** пользователя и показывает, на что из него сейчас есть скидка. Ни аккаунтов, ни логина для этого не нужно — вишлист Steam читается анонимно, если владелец не закрыл его настройками приватности.
